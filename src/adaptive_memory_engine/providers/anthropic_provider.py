...
class AnthropicProvider(IntelligentProvider):
    ...
    def __init__(
        self,
        api_key: str | None,
        embedding_fallback: EmbeddingProviderLike,  # type: ignore[name-defined]
        base_url: str = "https://api.anthropic.com/v1",
        chat_model: str = "claude-3-haiku-20240307",
...
if TYPE_CHECKING:
    from .base import EmbeddingProvider as EmbeddingProviderLike